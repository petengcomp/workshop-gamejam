...
export default class Game extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet("alien1", "./src/assets/img/alien1.png", {
      frameWidth: 400,
      frameHeight: 400,
    });
    this.load.spritesheet("alien1-dead", "./src/assets/img/alien1-dead.png", {
      frameWidth: 400,
      frameHeight: 400,
    });
    ...
    this.load.audio(
      "gameStartMusic",
      "./src/assets/audio/game-start-sound.mp3"
    );
    ...
    this.load.audio(
      "spaceSound",
      "./src/assets/audio/thriller-space-sound.mp3"
    );
  ...
  create() {
    ...
    this.coinSound = this.sound.add("collectCoinMusic", {
      loop: false,
      volume: 0.4,
    });
    ...
    this.anims.create({
      key: "alien1-dead",
      frames: this.anims.generateFrameNumbers("alien1-dead", {
        start: 0,
        end: 27,
      }),
      frameRate: 40,
  ...
  shot() {
    ...
    this.laserShotGroup.create(
      this.ship.x + this.shotPosition,
      this.ship.y - 10,
      "laserShotImg"
    );
  ...
  updateBackgroundVelocity() {
    // Evitar overflow
    if (this.backgroundVelocity === -1000000) this.backgroundVelocity = 0;
